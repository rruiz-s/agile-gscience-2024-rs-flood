...
![Fig.1 The lane obtain routable networks used ORS transforming the OSM network into a graph modeling the road network before and after the flooding](data/figures/obtain_routable_network.png)
...
<figcaption> A comparison between the original OSM network and its transformation into a routable graph by ORS
</figcaption>
</figure>
```
