...
The study area is located in the Federal Unit of Rio Grande do Sul, within the "central core" of the Porto Alegre Metropolitan
Region. It includes 9 municipalities classified as dense urban settlement according to the Global Human Settlement SMOD dataset.

![Fig 2. The lane of select area of interest used the flood extent to filter the road network](/data/figures/select_aoi_workflow.png)
...
<figcaption> The study area is located in the Federal Unit of Rio Grande do Sul, within the central core of the Porto Alegre Metropolitan Region. It includes 9 municipalities classified as dense urban settlement according to the Global Human Settlement SMOD dataset </figcaption> 
</figure>
```
