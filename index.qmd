...
* openrouteservice:v8.0.0 used following the described [docker file container](https://giscience.github.io/openrouteservice/run-instance/running-with-docker) instructions. Especifically, we used the docker settings found in the directory "~/agile-gscience-2024-rs-flood/data/docker_settings/docker-compose.yml" on the project's github.
