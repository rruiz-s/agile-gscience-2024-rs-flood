...
Based on the core metropolitan bounding box, we regularly sampled the OD separated by 0.037º. We used this OD to calculate the core metropolitan connectivity regularly. <span style="color:red;">Revise, maybe this is unnecesary in the delivered final version </span>

```{sql}
#| eval: false
#| echo: true
#| code-summary: "[ACR-7] How to create regular samples to calculate the Core Metropolitan Connectivity"
...
We repeated this process for each of the isochrones of the hospitals regularly sampling every 0.00912º. 
