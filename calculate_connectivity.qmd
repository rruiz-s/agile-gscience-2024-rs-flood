...
# Load all the rmarkdown_data ending in gpkg saving you time
library(tictoc)
library(tidyverse)
library(sf)
tic()
rmarkdown_data <- list.files(path= "/home/ricardors/agile-gscience-2024-rs-flood/data/rmarkdown_data", pattern="\\.gpkg")
for (i in seq_along(rmarkdown_data)) {
    file_name <- tools::file_path_sans_ext(rmarkdown_data[i])
    assign(file_name, sf::read_sf(paste0("~/agile-gscience-2024-rs-flood/data/rmarkdown_data/", rmarkdown_data[i])))
}
# Load non-gpkg files
centrality_both_sankey_v3 <- read.csv("~/agile-gscience-2024-rs-flood/data/rmarkdown_data/centrality_both_sankey_v3.csv")
df_centrality_both_sankey <- read.csv("~/agile-gscience-2024-rs-flood/data/rmarkdown_data/df_centrality_both_sankey.csv")
# Work on flat 
sf::sf_use_s2(FALSE)
...
#| eval: false
#| echo: true
#| code-summary: "How to visualise CM connectivity"
...
#| eval: false
#| echo: true
#| code-summary: "[ECR 14] How to calculate edge betweenness centrality in the IntraCity Area"
...
#| eval: false
#| echo: true
#| code-summary: "How to calculate edge betweenness centrality in the IntraCity Area after the flooding "
...
#| eval: false
#| echo: true
#| code-summary: "How to determine the final IC connectivity for the municipality of Canoas"
...
The @fig-mun contains two layers to visualize the IC and CM connectivity. While Nova Santa Rita was the municipality most affected by the flood with a 99% loss in the CM connectivity, Canoas is the most affected when using the IC connectivity with a 60% loss. 
